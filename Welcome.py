...
st.markdown('<h6 style = "text-align: center; padding-bottom: 0px; padding-top: 170px; font-family: Inter; font-size: 13px;">Welcome to</h6>', unsafe_allow_html= True)
st.markdown('<h2 style = "text-align: center; padding-top: 0px; margin-top: -5px; font-weight: bold; font-size: 50px;">SummaRead!</h2>', unsafe_allow_html= True)
