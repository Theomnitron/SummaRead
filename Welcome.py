...
st.markdown('<h6 style = "text-align: center; padding: 40% 0; font-family: Inter; font-size: 13px;">Welcome to</h6>', unsafe_allow_html= True)
st.markdown('<h2 style = "text-align: center; padding: 40% 0; margin-top: -5px; font-weight: bold; font-size: 50px;">SummaRead!</h2>', unsafe_allow_html= True)
